// webserver_dd.go - Web server for playing with Golang and Datadog
//
//         - This server will have some Data Dog metrics built into it.
...
//         - It looks for a DataDog Agent running in a container
//
// Author: Rob Egan
...
import (
	...
	"github.com/DataDog/datadog-go/statsd" // Datadog StatsD client library for Golang
)
...
const (
	whiteIndex    = 0
	blackIndex    = 1
	ddAgentServer = "192.168.99.100:8125" // IP/hostname and port of the DataDog Agent, which is a local docker container
